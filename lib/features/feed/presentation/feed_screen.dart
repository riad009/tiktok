...
// ── Custom scroll physics — TikTok-style hard snap ───────────────
class _SnapScrollPhysics extends ScrollPhysics {
  ...
  @override
  double get minFlingVelocity => 150.0;   // easy to trigger snap
  @override
      ...
      body: feedAsync.when(
        data: (videos) {
          ...
          return ScrollConfiguration(
            // Allow mouse-wheel & trackpad scrolling on web to snap pages
